...
export function WorkspaceNameStep({
  ...
  return (
    <div className="mx-auto flex max-w-[520px] flex-col items-center gap-4 pt-8 text-center">
      ...
      >
        <div className="relative w-full rounded-2xl border border-border bg-card p-5 text-start shadow-sm">
          ...
          <input
            ...
            className="mt-2 w-full border-0 bg-transparent p-0 text-xl font-bold tracking-tight leading-tight tracking-tight text-foreground outline-none placeholder:text-muted-foreground/40"
          />
        </div>
      ...
      <div className="mt-6 flex w-full max-w-[380px] items-center justify-between text-sm text-muted-foreground/80">
