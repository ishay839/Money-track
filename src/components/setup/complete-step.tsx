  ...
  return (
    <div className="mx-auto w-full max-w-[520px] space-y-7 text-center">
      ...
      <div>
        ...
        >
          בלחיצה למטה המערכת תמשוך את התנועות ותסווג אותן. אפשר לסנכרן
          מחדש בכל עת מלוח הבקרה או מההגדרות.
        </motion.p>
      </div>
...
function ImportProgress() {
  const [steps, setSteps] = useState<ImportStep[]>([
    { id: "connect", label: "מתחבר לחשבונות", state: "active" },
    { id: "fetch", label: "מוכן למשיכת 90 ימי פעילות", state: "todo" },
    { id: "cat", label: "מוכן לסיווג התנועות", state: "todo" },
    { id: "budgets", label: "מוכן להצעת יעדים ראשוניים", state: "todo" },
  ]);
