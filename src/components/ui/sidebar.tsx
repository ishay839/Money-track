      ...
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        ...
        >
          <SheetHeader className="sr-only">
            ...
            <SheetDescription>מציג את סרגל הניווט במכשיר נייד.</SheetDescription>
          </SheetHeader>
    ...
    >
      ...
      >
        <div
          ...
          className="flex size-full flex-col border-sidebar-border bg-sidebar group-data-[side=left]:border-e group-data-[side=right]:border-s group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:shadow-sm group-data-[variant=floating]:ring-1 group-data-[variant=floating]:ring-sidebar-border"
        >
          {children}
        </div>
      </div>
...
function SidebarRail({ className, ...props }: React.ComponentProps<"button">) {
  ...
  return (
    <button
      ...
      title="פתיחה או סגירה של סרגל הניווט"
      className={cn(
