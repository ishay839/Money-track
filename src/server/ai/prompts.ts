...
- Use short Hebrew names that describe a TYPE of spending, not a specific merchant. Good: "ציוד לחיות", "טיפול בילדים", "כלי עבודה", "ספרים ומדיה". Bad: a merchant name or a personal note.
- Write category names in Hebrew, 1-3 words.
